...
import cn.dm.dto.UmsPermissionNode;
import cn.dm.model.UmsPermission;
import cn.dm.service.UmsPermissionService;
...
public class UmsPermissionController {
    ...
    public CommonResult create(@RequestBody UmsPermission permission) {
        ...
        return CommonResult.failed("10500");
    }
    ...
    public CommonResult update(@PathVariable Long id, @RequestBody UmsPermission permission) {
        ...
        return CommonResult.failed("10501");
    }
    ...
    public CommonResult delete(@RequestParam("ids") List<Long> ids) {
        ...
        return CommonResult.failed("10502");
    }
